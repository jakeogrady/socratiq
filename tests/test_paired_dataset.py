...
def canonical_mapping(
    ...
    *,
    ...
    return {
        ...
        or f"{example_id} has a distinct arithmetic word problem with enough words.",
        "solution_steps": [
            {
            ...
            },
            {
                ...
                "reasoning": "The requested total is therefore 9.",
            },
        ],
        "final_answer": "#### 9",
...
class CanonicalValidationTests(unittest.TestCase):
    ...
    def test_incorrect_explicit_calculation_is_rejected(self) -> None:
        row = canonical_mapping("x-v01", "x", 1)
        row["solution_steps"][0]["reasoning"] = "The first quantity is 12 - 3 = 8."
    ...
    def test_last_explicit_result_must_match_final_answer(self) -> None:
        row = canonical_mapping("x-v01", "x", 1)
        row["solution_steps"][0]["reasoning"] = "The first quantity is 12 - 3 = 9."
        row["final_answer"] = "#### 10"
...
class DeduplicationTests(unittest.TestCase):
    ...
    def test_filter_rejects_exact_and_near_duplicates(self) -> None:
        ...
        rows = [
            ...
            canonical_mapping("c-v01", "c", 1, question=f"{base_question} eleven"),
            canonical_mapping(
                "d-v01",
                "d",
                1,
